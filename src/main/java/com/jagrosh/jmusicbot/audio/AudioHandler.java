...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler 
{
    ...
    public void onTrackException(AudioPlayer player, AudioTrack track, FriendlyException exception) {
        LoggerFactory.getLogger("AudioHandler").error("歌曲 " + track.getIdentifier() + " 播放失败", exception);
    }
    ...
    public Message getNowPlaying(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            mb.append(FormatUtil.filter(manager.getBot().getConfig().getSuccess()+" **正在播放在 "+guild.getSelfMember().getVoiceState().getChannel().getAsMention()+"...**"));
    ...
    public Message getNoMusicPlaying(JDA jda)
    {
        ...
        return new MessageBuilder()
                .setContent(FormatUtil.filter(manager.getBot().getConfig().getSuccess()+" **正在播放中...**"))
