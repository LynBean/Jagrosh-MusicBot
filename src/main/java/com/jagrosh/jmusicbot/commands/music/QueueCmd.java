...
public class QueueCmd extends MusicCommand 
{
    ...
    public QueueCmd(Bot bot)
    {
        super(bot);
        this.name = "queue";
        this.help = "显示当前队列 | Shows the current queue";
        this.arguments = "[页数Pagenum]";
    ...
    public void doCommand(CommandEvent event)
    {
        ...
        if(list.isEmpty())
        {
            ...
            Message built = new MessageBuilder()
                    .setContent(event.getClient().getWarning() + " 队列中没有音乐！| There is no music in the queue!")
    ...
    private String getQueueTitle(AudioHandler ah, String success, int songslength, long total, RepeatMode repeatmode)
    {
        ...
        return FormatUtil.filter(sb.append(success).append(" 当前队列|Current Queue | ").append(songslength)
                .append(" 歌曲|entries | `").append(FormatUtil.formatTime(total)).append("` ")
